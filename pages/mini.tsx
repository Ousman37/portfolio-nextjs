...
import miniImg from '../public/assets/projects/project.png';
  ...
  return (
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[30vh] relative">
        <div className="absolute top-0 left-0 w-full h-[30vh] lg:h-[30vh] bg-black z-10">
          <Image
            src={miniImg}
          ...
          <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] z-10 text-[#2294D6]">
            <h2 className="py-2">Web Design & Mini Project</h2>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-80">
          <div className="col-span-4">
            ...
            <p className="pt-4 text-lg text-gray-700">
              In my free time, I love to work on mini projects that allow me to
              hone my design skills. For this project, I created a website for a
              travel agent, focusing on both the design and development aspects
              of the site. I&apos;m proud of what I accomplished, and I&apos;m
              always looking for new challenges to help me grow as a designer
            </p>
