...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener('scroll', handlerShadow);
    };
  }, []);
  ...
  return (
    <div
      ...
      className={`sticky top-0 z-[100] ${shadow ? 'shadow-xl' : 'no-shadow'}`}>
      ...
      {nav && (
        <div className='fixed left-0 top-0 w-full h-screen bg-black/70'>
          <div className='fixed left-0 top-0 w-[70%] sm:-[60%] md:[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500'>
            <div>
              ...
              <ul
                ...
                <Link href='/'>
                  <li
                    ...
                    className='ml-10 text-sm sm:text-lg uppercase py-2 hover:border-b'>
                    Home
                  </li>
                </Link>
                <Link href='/#about'>
...
//             {/* ul Links  */}
//             <div className='py-4 flex flex-col'>
//               <ul style={{ color: linkColor }} className='md:flex sm:block'>
//                 <Link href='/'>
//                   <li
//                     onClick={() => setNav(false)}
//                     className='ml-10 text-sm sm:text-lg uppercase py-2 hover:border-b'>
